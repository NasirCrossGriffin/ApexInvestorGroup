...
router.post("/", async (req, res) => {
  ...
  try {
    await resend.batch.send([
      {
        from: "Trinity <no-reply@nasirgriffin.com>",
        to: [process.env.CLIENT_EMAIL],
        subject: "New website inquiry (Trinity Portfolio)",
        html: `
                  ...
                  <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="width:640px;max-width:94%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e9ecf2;">
                    <tr>
                      <td style="padding:24px 28px;background:#0b0b0d;">
                        <img
                          src="https://trinityportfolio.s3.us-east-1.amazonaws.com/public/Trinity+Logo.png"
                          alt="Trinity"
                    ...
                    <tr>
                      <td style="padding:18px 28px;background:#f9fafb;border-top:1px solid #e5e7eb;color:#6b7280;font-size:12px;line-height:18px;">
                        This message was sent automatically from the Trinity Portfolio contact form.
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center">
                  <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="width:640px;max-width:94%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e9ecf2;">
                    ...
                    <tr>
                      <td style="padding:18px 28px;background:#f9fafb;border-top:1px solid #e5e7eb;color:#6b7280;font-size:12px;line-height:18px;">
                        This is an automated confirmation from Trinity Portfolio. Please do not share sensitive personal information via email.
                      </td>
                    </tr>
                  </table>
                </td>
